...
const handlePasswordToggle=()=>{
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
        ...
        <input type="name" ref={userNameRef} required placeholder='name'/></div>
        
        <div className='inputContainer'>
        <input type="email" ref={userEmailRef} required placeholder='email id'/></div>

        <div className='inputContainer'>
        <input type={showPassword?'text':'password'} ref={userPasswordRef} placeholder='password'/>
        {showPassword?
